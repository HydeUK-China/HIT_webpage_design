...
<head>
    ...
    <title>Hyde International(UK) | Admin Profile | Project Proposal Collaboration</title>
    <meta charset="utf-8">
...
<section id="top" class="category-hero">
    ...
    <div class="main-box">
        <div class="admin-platform">
            ...
            <hr>
            <nav class="left-nav"><a href="admin_dashboard.php">Dashboard</a> </nav>
            <br>
            <nav class="left-nav"><a href="admin_expert_database.php">Expert Database</a> </nav>
            <br>
            <nav class="left-nav"><a href="project_proposal_collaboration.php">Project Porposal
                    Collaboration</a> </nav>
            <br>
            <nav class="left-nav"><a href="expert_assessment.php">Expert Assessment</a> </nav>
        </div>

        <div class="container">
            <header class="welcome-admin">Welcome to Hyde International Talents (HIT) Admin Portal</header>
            <section class="search">
                <label for="validationTooltip01">Grade / Score :</label>
                <input type="text" placeholder="A / 55" required>
            ...
            <section class="database">
                <table>
                    <tr>
                        <td><label for="validationTooltip01">Applicant ID</label></td>
                        <td> <label for="validationTooltip01">First Name</label></td>
                        <td> <label for="validationTooltip01">Last Name</label></td>
                        <td> <label for="validationTooltip01">手动评级 (A)</label></td>
                        <td> <label for="validationTooltip01">Grade</label></td>
                    </tr>
                    <tr>
                        <td colspan="5" rowspan="5"><span
                                style="text-align: center; padding-top: 3rem; position: relative; left: 40%;">Output</span>
                        </td>
                    </tr>
